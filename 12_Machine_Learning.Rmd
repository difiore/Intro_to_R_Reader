...
ForestPredict <- predict(ForestFit, newdata = irisTest)
...
This tells us that we've built 500 decision trees for our training sample of 114 observations, using all 4 predictors in at least _some_ of the trees, with 
