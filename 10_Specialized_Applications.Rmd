...
## Sampling
When we perform statistical analyses, we almost always work on sample data - that is, data that represents all data on the subject that exists, but is not that full dataset. 
